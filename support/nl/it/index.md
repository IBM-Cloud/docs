...
**Orario di operatività:** domenica 22:00 GMT – venerdì 23:59 GMT (escluse festività di Stati Uniti/Italia/Australia). Per ulteriori informazioni sulla pianificazione delle festività, vedi [Bluemix Support Holidays ![icona link esterno](../icons/launch-glyph.svg)](http://ibm.biz/bluemixholidays){: new_window}. 
...
in esecuzione utilizzando il comando `cf api`.
  ...
  3. Assicurati di soddisfare tutti i prerequisiti in [Prerequisiti di {{site.data.keyword.Bluemix_notm}} ![icona link esterno](../icons/launch-glyph.svg)](https://developer.ibm.com/bluemix/support/#prereqs){: new_window}.
