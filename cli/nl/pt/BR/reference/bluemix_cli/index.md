...
Para ver a versão do IBM Containers, execute `bluemix ic info`. Para obter mais informações, consulte o comando [version](https://docs.docker.com/engine/reference/commandline/version/){: new_window} na ajuda do Docker.
...
Sair de um contêiner e exibir o código de saída como confirmação. Para obter mais informações, consulte o comando [wait](https://docs.docker.com/engine/reference/commandline/wait/){: new_window} na ajuda do Docker.
