...
This CLI has been deprecated: Instead of using the Development mode (dev_mode) CLI, use the Bluemix CLI. You can continue to use the dev_mode CLI until 30 June 2016.
