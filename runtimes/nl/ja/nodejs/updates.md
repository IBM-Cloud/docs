...
*最終更新日時: 2016 年 6 月 22 日*
{: .last-updated}

sdk-for-nodejs ビルドパックの最新更新のリスト。
## 2016 年 6 月 22 日: 更新された Node.js ビルドパック v3.5-20160608-1102
...
IBM Node.js ビルドパック v3.0beta は現在、Node.js v4.2.3 をデフォルト・ランタイムとして、Bluemix 上に非デフォルト・ビルドパックとしてリリースされています。アプリケーションおよびサービスが引き続き Bluemix 上で機能するようにするために、ベータ版のビルドパックを使用してアプリケーションをプッシュしてください。30 日以上が経過すると、v3 がデフォルト・ビルドパックになります。
