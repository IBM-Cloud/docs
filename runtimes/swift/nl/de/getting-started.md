...
# Erste Schritte mit Swift unter Bluemix
...
Übertragen Sie Ihre App mit einer Push-Operation aus dem Verzeichnis *get-started-swift* zu {{site.data.keyword.Bluemix_notm}}
   ```
cf push
```
   {: pre}
