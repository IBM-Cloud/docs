...
Liberty for Java 런타임에서는 일부 Liberty 베타 기능도 사용 가능합니다. 이러한 기능은 표에는 나열되어 있지 않지만 <a href="https://new-console.ng.bluemix.net/docs/runtimes/liberty/usingBetaFeatures.html">베타 기능 사용</a>에서 찾을 수 있습니다.
