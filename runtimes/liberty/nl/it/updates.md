...
* La versione del runtime Liberty predefinita `16.0.0.3` è stata aggiornata per includere le iFixe [PI68805](http://www-01.ibm.com/support/docview.wss?uid=swg1PI68805) e [PI69141](http://www-01.ibm.com/support/docview.wss?uid=swg1PI69141). 
...
* Il pacchetto di build è stato nuovamente modificato per scaricare l'ultimo 1.5.x [MariaDB Connector/J JDBC driver](https://mariadb.com/kb/en/mariadb/about-mariadb-connector-j/) quando di esegue la [configurazione automatica per il tipo MySQL dei servizi](autoConfig.html).
...
* Il pacchetto di build include anche una serie di miglioramenti di [Diego](https://docs.cloudfoundry.org/concepts/diego/diego-architecture.html) correlati al controllo di integrità dell'applicazione e la funzionalità [Gestione applicazione](/docs/manageapps/app_mng.html).
