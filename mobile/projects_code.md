...
2. Make your selections on the **Project Overview** screen.  The **Project Overview** screen displays information about your project and the optional services that you can add to your project, like Push Notifications.  

	1. Optional: Select **Add** to add one of the listed services to your project. When you add services to your project, you link to the main {{site.data.keyword.Bluemix_notm}} Console. Select the *Mobile* category in the {{site.data.keyword.Bluemix_notm}} Console to view the Mobile services.  Select *Push Notifications* or another service to set it up. Configure the service by following the instructions for the service.
