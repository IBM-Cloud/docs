...
---
# SDK, ejemplos y referencia de API
{: #sdk}
...
<p>SDK en GitHub</p>
	<ul><li><a href="https://github.com/ibm-bluemix-mobile-services/bms-clientsdk-android-core" rel="external" title="(Se abre en un nuevo separador o ventana)" target="_blank">bms-clientsdk-android-core</a></li>
...
DevOps</a></p>
-->
<p>SDK en {{site.data.keyword.IBM}} DevOps</p>
<ul>
<li><a href="https://hub.jazz.net/git/bluemixmobilesdk/imf-ios-sdk/archive?revstr=master" rel="external" title="(Descarga un archivo de archivado)" target="_blank">Bluemix MobileFirst Services SDK for iOS</a></li>
</ul>
