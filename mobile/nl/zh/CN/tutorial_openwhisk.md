...
# {{site.data.keyword.openwhisk_short}} 入门模板端到端教程
{: #tutorial}

以下端到端教程将引导您完成通过 {{site.data.keyword.openwhisk_short}}“代码入门模板”创建项目的步骤（包括必须安装的工具）以及在 Xcode 和 Android Studio 中运行入门模板的步骤。
...
### 通过 {{site.data.keyword.openwhisk_short}}“代码入门模板”创建项目
{: #create_project}
...
1. 在 {{site.data.keyword.Bluemix}} 中创建 Mobile 仪表板项目。
   ...
   3. 选择 **{{site.data.keyword.openwhisk_short}}** 并单击**创建项目**。

   4. 输入项目名称。对于本教程，请使用 `{{site.data.keyword.openwhisk_short}}Project`。
   
   5. 单击**创建**。

2. 可选：添加 {{site.data.keyword.mobilepushshort}} 功能。

   **注**：如果您想要运行 `pushAction`，您必须添加并配置 {{site.data.keyword.mobilepushshort}}。
...
1. 解压缩 `{{site.data.keyword.openwhisk_short}}Project-Swift.zip` 文件。
...
2. 在 Markdown 查看器中打开 `README.md` 文件，以查看配置项目的步骤。
   ...
   3. 打开 `{{site.data.keyword.openwhisk_short}}Project.xcworkspace` Xcode 工作空间。

   4. 如果您想要运行 `pushAction`，您必须配置 {{site.data.keyword.mobilepush}}。
...
1. 解压缩 `{{site.data.keyword.openwhisk_short}}Project-Android.zip` 文件。

2. 在 Markdown 查看器中打开 `README.md` 文件，以配置项目。

   1. 在 Android Studio 中打开 `{{site.data.keyword.openwhisk_short}}Project-Android` 项目。

   2. 如果您想要运行 `pushAction`，您必须配置 {{site.data.keyword.mobilepush}}。
