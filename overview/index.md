...
| Austrialia Sydney region | au-syd | api.au-syd.{{site.data.keyword.Bluemix_notm}}.net | console.au-syd.{{site.data.keyword.Bluemix_notm}}.net |
...
* [{{site.data.keyword.Bluemix_notm}} glossary](/glossary/glossary.html)
