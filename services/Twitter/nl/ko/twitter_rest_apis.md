...
| `followers_count:lowerLimit,upperLimit` 	| 지정된 범위 내의 팔로워 수를 갖는 사용자의 트윗을 일치로 판별합니다. 상한 바인드는 선택사항이며 두 한도의 끝 수는 포함됩니다.  	| `followers_count:500` 	|
| `friends_count:lowerLimit,upperLimit` 	| 지정된 범위 내의 사용자 수를 팔로우하는 사용자의 트윗을 일치로 판별합니다. 상한 바인드는 선택사항이며 두 한도의 끝 수는 포함됩니다.  	| `friends_count:1000,3000` 	|
...
| `listed_count:lowerLimit,upperLimit` 	| Twitter의 작성자 목록이 지정된 범위 내에 있는 트윗을 일치로 판별합니다. 상한 바인드는 선택사항이며 두 한도의 끝 수는 포함됩니다.  	| `listed_count:1000,3000` 	|
...
| `statuses_count:lowerLimit,upperLimit` 	| 지정된 범위 내의 상태 수를 게시한 사용자의 트윗을 일치로 판별합니다. 상한 바인드는 선택사항이며 두 한도의 끝 수는 포함됩니다.  	| `statuses_count:1000,3000` 	|
...
지원되는 모든 쿼리 용어를 위의 부울 연산자를 사용하여 결합할 수 있습니다. 예를 들면 다음과 같습니다.
