...
de Autorização no código Android (Java) ou iOS (Objective C). 
Inicialize o cliente e faça solicitações para os recursos
protegidos
...
name="android">`:
	...
	O valor *minSdkVersion* deve ser `15` ou mais alto. 
O valor *targetSdkVersion* deve ser
