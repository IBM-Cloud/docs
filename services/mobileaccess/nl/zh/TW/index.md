...
**{{site.data.keyword.amafull}} 服務取代為 [{{site.data.keyword.appid_full}} 服務](/docs/services/appid/index.html)。**如果您在移到 {{site.data.keyword.appid_short_notm}} 之前需要 {{site.data.keyword.amashort}} 的相關資訊，請參閱下列頁面。
{:shortdesc}
