...
*  找到托管 {{site.data.keyword.Bluemix_notm}} 应用程序的区域。您可以在**头像**图标 ![“头像”图标](images/face.jpg "“头像”图标") 旁边的标题中找到当前 Bluemix 区域。区域值应为以下某个值：**美国南部**、**悉尼**或**英国**。对应于这些名称的准确 SDK 常量值如代码示例中所示。 
* （可选）请熟悉以下部分：
...
3.  `GoogleAuthenticationManager` API 仍必须使用本机代码进行注册。将此代码添加到主活动 `onCreate` 方法： 
