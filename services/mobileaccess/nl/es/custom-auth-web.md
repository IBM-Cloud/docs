...
2. Pulse el icono de aplicación relevante de {{site.data.keyword.amashort}}. Se cargará el panel de control de la app. 
3. Pulse el botón **Configurar** en el icono Personalizado. 
