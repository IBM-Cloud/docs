...
## 15. März 2017: WebSphere Application Server in {{site.data.keyword.Bluemix_notm}} aktualisiert

* Verschiedene Funktionen für die Servicewartung wurden integriert.
* Upgrade der WebSphere Application Server in {{site.data.keyword.Bluemix_notm}}-Binärdateien, damit für neue Instanzen des klassischen WebSphere Application Server Fixpack 8.5.5.11 oder 9.0.0.3 installiert wird. 
...
## 10. Februar 2017: WebSphere Application Server in {{site.data.keyword.Bluemix_notm}} aktualisiert

* Verschiedene Funktionen für die Servicewartung wurden integriert.
* Upgrade der WebSphere Application Server in {{site.data.keyword.Bluemix_notm}}-Binärdateien, damit für neue Instanzen des klassischen WebSphere Application Server Fixpack 8.5.5.11 oder 9.0.0.2 installiert wird. 
* Upgrade der WebSphere Application Server in {{site.data.keyword.Bluemix_notm}}-Binärdateien, damit für neue Instanzen von WebSphere Application Server Liberty (Core- und ND-Pläne) Fixpack 16.0.0.4 installiert wird. 
...
## 16. Dezember 2016: WebSphere Application Server in {{site.data.keyword.Bluemix_notm}} aktualisiert
...
## 08. November 2016: WebSphere Application Server in {{site.data.keyword.Bluemix_notm}} aktualisiert
...
## 19. September 2016: WebSphere Application Server in {{site.data.keyword.Bluemix_notm}} aktualisiert

* Upgrade der WebSphere Application Server in {{site.data.keyword.Bluemix_notm}}-Binärdateien, damit für neue Instanzen von WebSphere Application Server Liberty (Core- und ND-Pläne) Fixpack 16.0.0.3 installiert wird. 
...
## 17. August 2016: WebSphere Application Server in {{site.data.keyword.Bluemix_notm}} aktualisiert

* Die Binärdateien von WebSphere Application Server in Bluemix wurden von Version 8.5.5.9 auf Version 8.5.5.10 aktualisiert
...
## 24. Juni 2016: WebSphere Application Server in {{site.data.keyword.Bluemix_notm}} aktualisiert
...
## 13. Juni 2016: WebSphere Application Server in {{site.data.keyword.Bluemix_notm}} aktualisiert

* Clients können nun mithilfe einer Anwendung oder eines Scripts, die bzw. das REST-konforme APIs von WebSphere Application Server in Bluemix nutzt, VM-Instanzen erstellen, bereitstellen, verwalten und löschen.
...
## 26. April 2016: WebSphere Application Server in {{site.data.keyword.Bluemix_notm}} aktualisiert
...
## 15. April 2016: WebSphere Application Server in {{site.data.keyword.Bluemix_notm}} aktualisiert
...
## 19. Februar 2016: WebSphere Application Server in {{site.data.keyword.Bluemix_notm}} aktualisiert
...
## 11. Dezember 2015: WebSphere Application Server in {{site.data.keyword.Bluemix_notm}} aktualisiert
