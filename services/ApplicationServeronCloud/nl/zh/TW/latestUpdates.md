...
* 已將 WebSphere Application Server in Bluemix 二進位檔從 8.5.5.9 升級到 8.5.5.10
...
* 已新增功能，透過建立使用 WebSphere Application Server in Bluemix RESTful API 的應用程式或 Script，讓客戶建置、佈建、管理及刪除虛擬機器實例。
