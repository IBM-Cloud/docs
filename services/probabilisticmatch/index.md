...
Refer to the [Swagger API documentation](https://www.stage1.ng.bluemix.net/docs/api/content/api/probabilisticmatch/rest-api/index.html){:new_window}, where you can see the model schema that you must use for your data. 
...
>* [{{site.data.keyword.probmatchshort}} Sample Web App](https://hub.jazz.net/project/probabilisticmatch/sample/overview)
>
># Related Links {:class="linklist"}
>## API REFERENCE {:id="api"}
>* [REST API for {{site.data.keyword.probmatchshort}}](https://www.stage1.ng.bluemix.net/docs/api/content/api/probabilisticmatch/rest-api/index.html){:new_window}
>
># Related Links {:class="linklist"}
