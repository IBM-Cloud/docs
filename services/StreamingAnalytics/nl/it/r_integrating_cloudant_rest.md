...
Una serie di esercitazioni è disponibile per aiutarti nell'integrazione di {{site.data.keyword.streaminganalyticsshort}} con altri servizi {{site.data.keyword.Bluemix_short}}:
...
* [Accesso alle origini dati {{site.data.keyword.eventhubshort}} da {{site.data.keyword.streaminganalyticsshort}}](https://developer.ibm.com/bluemix/2016/06/24/message-connect-data-sources-from-streaming-analytics/){:new_window}
