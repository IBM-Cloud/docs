...
Es steht eine Reihe von Lernprogrammen zur Verfügung, die Ihnen helfen,
{{site.data.keyword.streaminganalyticsshort}} mit anderen {{site.data.keyword.Bluemix_short}}-Services zu integrieren:
