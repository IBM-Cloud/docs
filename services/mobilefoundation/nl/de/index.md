...
## Einführung in den {{site.data.keyword.mobilefoundation_short}}: Developer Pro-Plan
...
## Einführung in den {{site.data.keyword.mobilefoundation_short}}: Professional Per Capacity-Plan
...
Nachdem Sie eine Instanz von {{site.data.keyword.mobilefoundation_short}}: Professional Per Capacity-Service erstellt haben, können Sie mit der Erstellung Ihres mobilen Kanals beginnen, indem Sie die folgenden Schritte ausführen.
  ...
  1.  Stellen Sie eine Verbindung zu einem vorhandenen {{site.data.keyword.dashdbshort}} for Transactions-Service in {{site.data.keyword.Bluemix_notm}} her.
      ...
      + Testen Sie die Verbindung zu der ausgewählten Serviceinstanz von {{site.data.keyword.dashdbshort_notm}} for Transactions, indem Sie auf **Verbindung testen** klicken.
...
Lesen Sie den Abschnitt [MobileFirst Server mithilfe von Mobile Foundation-Service einrichten<!-- on IBM Containers--> ![Symbol für externen Link](../../icons/launch-glyph.svg "Symbol für externen Link")](https://mobilefirstplatform.ibmcloud.com/tutorials/en/foundation/8.0/bluemix/using-mobile-foundation/ "Symbol für externen Link"){: new_window}, um mehr darüber zu erfahren, wie Sie mit der Verwendung von {{site.data.keyword.mobilefoundation_short}} beginnen.
...
*	[Produktdokumentation für IBM MobileFirst Platform Foundation V8.0.0 ![Symbol für externen Link](../../icons/launch-glyph.svg "Symbol für externen Link")](https://www.ibm.com/support/knowledgecenter/SSHS8R_8.0.0/wl_welcome.html "Symbol für externen Link"){: new_window}
*	[IBM MobileFirst Platform Developer Center ![Symbol für externen Link](../../icons/launch-glyph.svg "Symbol für externen Link")](https://mobilefirstplatform.ibmcloud.com "Symbol für externen Link"){: new_window}
