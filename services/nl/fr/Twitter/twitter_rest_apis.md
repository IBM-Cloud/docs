...
| `followers_count:lowerLimit,upperLimit` 	| Recherche les tweets des utilisateurs qui ont un nombre de suiveurs compris dans la plage définie. La limite supérieure est facultative et les
deux limites sont inclusives. 	| `followers_count:500` 	|
| `friends_count:lowerLimit,upperLimit` 	| Recherche les tweets des utilisateurs qui suivent un nombre d'utilisateurs compris dans la plage définie. La limite supérieure est facultative et les
deux limites sont inclusives. 	| `friends_count:1000,3000` 	|
...
| `listed_count:lowerLimit,upperLimit` 	| Recherche les tweets dont la liste Twitter de l'auteur est comprise dans la plage définie. La limite supérieure est facultative et les
deux limites sont inclusives. 	| `listed_count:1000,3000` 	|
