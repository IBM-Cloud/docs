...
#	Übersicht über {{site.data.keyword.mobilefoundation_short}}
...
{{site.data.keyword.mobilefoundation_short}} bietet Benutzern eine einfache Möglichkeit unter Anleitung {{site.data.keyword.mfserver_short_notm}} in der {{site.data.keyword.containerlong}}-Umgebung in Bluemix einzurichten. 
...
*	Verwalten des eigenen Portfolios für die mobile App über eine einzige zentrale Schnittstelle und Entwickeln mobiler Apps
mithilfe Ihrer eigenen bevorzugten IDEs und Bibliotheken.
