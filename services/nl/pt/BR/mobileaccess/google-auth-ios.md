...
1. Anote o novo ID de cliente iOS. É necessário o valor ao configurar o aplicativo no {{site.data.keyword.Bluemix}}.


## Configurando o {{site.data.keyword.amashort}} para autenticação do Google
{: #google-auth-ios-config}

Agora que você tem um ID de cliente iOS, será possível ativar a autenticação do Google no painel do {{site.data.keyword.Bluemix_notm}}.
...
1. Em **ID do aplicativo para iOS**, especifique o ID do cliente iOS para Android e clique em **Salvar**.
...
arquivo `info.plist`
	...
	O primeiro Esquema de URL é uma versão reversa do ID do cliente do Google Developer Console. Por exemplo, se o ID do cliente for `123123-abcabc.apps.googleusercontent.com`, o Esquema de URL será: `com.googleusercontent.apps.123123-abcabc`.
