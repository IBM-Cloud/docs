...
4. **푸시 알림** 영역에서 개발 SSL 인증서를 작성한 다음 프로덕션 SSL 인증서를 작성하십시오. ![푸시 알림 SSL 인증서](images/certificate_createssl.jpg)
...
18. **비밀번호 입력** 화면에서 내보낸 항목을 보호하기 위한 비밀번호를 입력하고
