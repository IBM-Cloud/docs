...
| `followers_count:lowerLimit,upperLimit` 	| 与关注者人数位于指定范围内的用户发布的推文相匹配。上限是可选的，上限值和下限值均包含在内。 	| `followers_count:500` 	|
| `friends_count:lowerLimit,upperLimit` 	| 与关注用户数位于指定范围内的用户发布的推文相匹配。上限是可选的，上限值和下限值均包含在内。 	| `friends_count:1000,3000` 	|
...
| `listed_count:lowerLimit,upperLimit` 	| 与 Twitter 的作者列表位于指定范围内的推文相匹配。上限是可选的，上限值和下限值均包含在内。 	| `listed_count:1000,3000` 	|
...
| `statuses_count:lowerLimit,upperLimit` 	| 与已发布的状态数位于指定范围内的用户发布的推文相匹配。上限是可选的，上限值和下限值均包含在内。 	| `statuses_count:1000,3000` 	|
