...
per l'elemento media.
    ...
    * **source**
        ...
        Le origini dei video che non sono ospitati su
...
pagina web viene aperta in una nuova scheda del browser.  
    ...
    * **userDefinedService**
        ...
        Metadati per i servizi definiti dall'utente. 
        * **parameters**
	
	        Un array di coppie chiave-valore
definite dal servizio quando viene creata l'istanza del servizio. 
            ...
            * **parameters.type**
		        ...
		        The type of input field that is displayed by the Bluemix user interface. Il valore può essere text o password.
		    ...
		    * **parameters.displayname**
		        ...
		        Il nome del parametro che viene visualizzato.
			
		    * **parameters.invalidmessage**
		
		        Il messaggio che viene visualizzato quando il contenuto della casella di testo non è valido.
			
		    * **parameters.description**
		
		        La descrizione del parametro che viene visualizzata per aiutare gli
utenti con il valore del parametro.
            ...
            * **parameters.pattern**
		        ...
		        Specifica un'espressione regolare rispetto alla quale viene controllato il valore. 
			
		    * **parameters.placeholder**
		
		        Specifica un breve suggerimento che descrive il valore previsto.
			
		    * **parameters.readonly**
		
		        Un valore booleano che indica se il valore del parametro viene solo visualizzato e
non può essere modificato dagli utenti. Il valore predefinito è false.
			
		    * **parameters.hidden**
		
		        Un valore booleano che indica se la coppie chiave-valore è nascosta
agli utenti. Il valore predefinito è false.
	    ...
	    ```
        {
           ...
           "metadata": {
             "featuredDescription": "Un servizio fornito dall'utente. Solo per utilizzo informativo, non per l'utilizzo in produzione.",
             "isFeatured": false,
