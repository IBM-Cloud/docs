# Abilitazione dell'autenticazione Facebook nelle applicazioni iOS
{: #facebook-auth-ios}
...
1. Fai clic su **Opzioni mobili** e annota *applicationRoute* e *applicationGUID*. Questi valori ti servono quando inizializzi l'SDK.
 ...
 **Importante**: da questo punto, devi aprire il tuo progetto utilizzando un file `xcworkspace` che viene generato da CocoaPods. Di norma, il
...
### Configurazione del progetto iOS per l'autenticazione Facebook
...
1. Apri la pagina principale del dashboard {{site.data.keyword.Bluemix_notm}} e fai clic sulla tua applicazione. Fai clic su **Opzioni mobili**. Vengono visualizzati i valori di rotta applicazione (*Application Route*) e GUID applicazione (*Application GUID*).
...
3. Inizializza l'SDK client. Sostituisci applicationRoute e applicationGUID con i valori che hai ottenuto da **Opzioni mobili** nel
