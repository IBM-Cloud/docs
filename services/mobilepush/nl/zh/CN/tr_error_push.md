...
**用户响应**：请确保已使用有效的 APNs 安全证书配置 {{site.data.keyword.mobilepushshort}}服务。有关更多信息，请参阅[为 APNs 配置凭证](t_push_provider_ios.html){: new_window}。
...
**用户响应**：请验证请求中的 JSON 主体是否遵循 {{site.data.keyword.mobilepushshort}} 服务器所预期的请求格式。有关更多信息，请参阅 [REST API](https://mobile.{DomainName}/imfpush/)。
