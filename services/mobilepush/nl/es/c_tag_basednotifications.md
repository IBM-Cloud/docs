...
### Obtención de etiquetas en Google Chrome, Safari y Mozilla Firefox
{: #web-get-tags}
...
### Obtención de etiquetas en apps y extensiones de Google Chrome
{: #ext-get-tags}
...
Copie el siguiente fragmento de código en las apps y extensiones de Google Chrome para obtener una lista de etiquetas a las que están suscritos los clientes.
...
### Suscripción y cancelación de la suscripción a etiquetas en Google Chrome y Mozilla Firefox
{: #web-subscribe-tags}
...
Cree etiquetas con la opción **Gestionar etiquetas**.  
