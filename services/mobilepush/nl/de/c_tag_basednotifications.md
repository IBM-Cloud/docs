...
Tagbasierte Benachrichtigungen haben alle diejenigen Geräte zum Ziel, die einen bestimmten Tag subskribiert haben. 
...
### Tags in Google Chrome, Safari und Mozilla Firefox abrufen
{: #web-get-tags}
...
### Tags in Google Chrome-Apps und -Erweiterungen abrufen
{: #ext-get-tags}
...
Kopieren Sie das folgende Code-Snippet in Ihre Google Chrome-Apps und Erweiterungen, um eine Liste von Tags abzurufen, die von Kunden subskribiert wurden.
...
### Tags mit Google Chrome und Mozilla Firefox subskribieren und die Subskription aufheben
{: #web-subscribe-tags}
...
Erstellen Sie Tags mit der Option **Tags verwalten**. 
