...
### Obtendo tags no Google Chrome, Safari e Mozilla Firefox
{: #web-get-tags}

Para obter a lista de tags disponíveis as quais os clientes podem assinar, use o código a seguir.
...
### Obtendo tags nos Apps Google Chrome e Extensões
{: #ext-get-tags}
...
Copie o fragmento de código a seguir nos Apps Google Chrome e Extensões para obter uma lista de tags nas quais os clientes se inscreveram.
...
### Assinando e removendo assinatura de tags no Google Chrome e Mozilla Firefox
{: #web-subscribe-tags}
...
Crie tags usando a opção **Gerenciar tags**. 
