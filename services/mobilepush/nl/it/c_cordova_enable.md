...
Puoi abilitare le applicazioni Cordova a ricevere e inviare le notifiche di push ai tuoi dispositivi. 
...
Prima della registrazione, inizializza il servizio {{site.data.keyword.mobilepushshort}}.
```
...
Il seguente frammento di codice JavaScript mostra come inizializzare il tuo Bluemix Mobile Services client SDK, registra un dispositivo con il servizio {{site.data.keyword.mobilepushshort}} e ascolta le notifich push. Inserisci questo codice nel tuo file Javascript. 
