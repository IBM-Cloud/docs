...
|:---|:---|
|[Blockchain-Basisvertrag](https://github.com/ibm-watson-iot/blockchain-samples/tree/master/simple_contract_hyperledger) |Ein Vertrag, mit dem Sie Assetdaten zu Geräten in Blockchain verfolgen und speichern können.
|[Trade Lane-Blockchain-Vertrag](https://github.com/ibm-watson-iot/blockchain-samples/tree/master/trade_lane_contract_hyperledger) |Eine erweiterte Version des Blockchain-Basisvertrags.|
...
Bevor Sie an die neuen intelligenten Blockchain-Verträge Gerätedaten schreiben, müssen Sie den Verträgen zunächst Gerätedaten zuordnen.  
   ...
   4. Klicken Sie auf die Option für **Starten**, um das {{site.data.keyword.iot_short_notm}}-Dashboard zu öffnen.
...
**Tipp:** Wenn Sie die Benutzerschnittstelle für die Überwachung nicht in Ihrer lokalen Umgebung installiert haben, können Sie dies jetzt tun. Folgen Sie den Anweisungen im Readme-Dokument der Benutzerschnittstelle für die Überwachung, das im GitHub-Verzeichnis der [Blockchain-Benutzerschnittstelle für die Überwachung](https://github.com/ibm-watson-iot/blockchain-samples/tree/master/monitoring_ui) verfügbar ist. Rufen Sie die Konfigurationseinstellungen durch Klicken auf die Schaltfläche **Konfiguration** auf.
