...
실시간 디바이스 데이터를 표시하는 방법에 대한 단계별 지시사항은 [새 Watson IoT 대시보드에서 보드 및 카드 구성](https://developer.ibm.com/recipes/tutorials/configuring-the-cards-in-the-new-watson-iot-dashboard/) 레시피를 참조하십시오. 
