...
La determinazione dei prezzi {{site.data.keyword.iot_short_notm}} consente un numero illimitato di dispositivi registrati, 100 MB di scambio dati e un costo al MB di scambio dati dopo i primi 100 MB.

Per maggiori informazioni sulla determinazione dei prezzi {{site.data.keyword.iot_short_notm}}:

1. Dal tuo dashboard {{site.data.keyword.Bluemix_notm}}, fai clic su {{site.data.keyword.iot_short_notm}}.
