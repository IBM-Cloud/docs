...
1. In your Jenkins server, complete these steps:
 ...
 d. In each job, complete these steps:
  ...
  * Add a post-build action for IBM Cloud DevOps - Webhook Notification and select **Job Completed**.
 
 e. In your deploy job, complete these steps:
  ...
  * In the **Build** field, enter these commands to log in and push your app to Cloud Foundry:
     ```
     cf api $CF_API
