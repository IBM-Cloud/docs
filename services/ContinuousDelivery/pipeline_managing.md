...
For more information on extending pipeline capabilities, see [Extending the {{site.data.keyword.deliverypipeline}} service's capabilities](/docs/services/ContinuousDelivery/deliverypipeline_extension.html).
