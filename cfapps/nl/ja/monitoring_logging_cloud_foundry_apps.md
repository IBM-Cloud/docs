...
るアプリのロギング』 ](../monitor_log/monitoringandlogging.html#logging_for_bluemix_apps)を参照してください。
...
Cloud Foundry アプリケーションのモニターとロギングについて詳しくは、『[モニターとロギング](../monitor_log/monitoringandlogging.html)』を参照してください。
