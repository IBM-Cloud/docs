...
* The cost estimators on the {{site.data.keyword.Bluemix_notm}} 
...
1. Go to the {{site.data.keyword.Bluemix_notm}} [pricing page](https://www.ibm.com/cloud-computing/bluemix/pricing). 
