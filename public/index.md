...
If you are using the {{site.data.keyword.Bluemix_notm}} user interface, you can switch to a different region to work with the spaces in that region. Go to the {{site.data.keyword.avatar}} icon ![Avatar icon](../icons/i-avatar-icon.svg) and expand the **Region** selector. Then, you can select a different region from the list.
