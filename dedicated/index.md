...
<dd>
{{site.data.keyword.Bluemix_dedicated_notm}} environment can be set to be completely isolated from any public Internet connection. Access is provided through dedicated private link from your data center into {{site.data.keyword.Bluemix_dedicated_notm}} for a total private connection. Private connection line is available through <a href="http://www.softlayer.com/direct-link" target="_blank">Direct Link</a> technology.
<br>
