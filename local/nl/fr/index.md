...
<dd>Collabore avec les interlocuteurs IBM pour établir votre environnement {{site.data.keyword.Bluemix_notm}} local, notamment en identifiant les
...
les contextes d'exécution {{site.data.keyword.Bluemix_notm}}. Ce rôle collabore également avec les interlocuteurs IBM sur la configuration de votre
...
Les paramètres et les configurations de l'environnement {{site.data.keyword.Bluemix_notm}} local sont sauvegardés régulièrement pour
pallier
