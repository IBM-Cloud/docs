...
This package allows you to communicate with [Message Hub](https://developer.ibm.com/messaging/message-hub) instances for consuming messages using native high performance Kafka API.
{: shortdesc}
