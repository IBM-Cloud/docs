...
En tant que propriétaire de compte, vous pouvez gérer vos organisations en cliquant sur l'icône **{{site.data.keyword.avatar}}** ![icône Avatar](../icons/i-avatar-icon.svg) &gt; **Gérer les organisations**. Un
