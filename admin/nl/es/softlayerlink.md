...
Una vez que las cuentas estén enlazadas, puede cambiar entre las cuentas fácilmente. Podrá seguir supervisando el uso de los recursos de
{{site.data.keyword.Bluemix_notm}} en la interfaz de usuario de {{site.data.keyword.Bluemix_notm}}. Sin embargo, la facturación por estos recursos ahora aparecerá en la factura de SoftLayer.

Aunque la facturación de la cuenta se enlazará, el ID de inicio de sesión variará en función de cómo se autentique la cuenta de SoftLayer:
* Para los usuarios de cuentas de SoftLayer que no utilicen el ID de IBM para la autenticación, siga utilizando el ID de SoftLayer para los productos y servicios de SoftLayer y utilice el ID de IBM para los productos y servicios de
{{site.data.keyword.Bluemix_notm}}.
* Para usuarios de cuentas de SoftLayer que utilicen el ID de IBM para la autenticación, utilice el ID de IBM para acceder a sus cuentas tanto de SoftLayer como de {{site.data.keyword.Bluemix_notm}}.
...
Para invitar a miembros a través de {{site.data.keyword.Bluemix_notm}}:
 1. Vaya al icono **{{site.data.keyword.avatar}}** ![Icono
Avatar](../icons/i-avatar-icon.svg) > Cuentas > Invitar miembros del equipo.
