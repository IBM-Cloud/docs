...
### 添加 SoftLayer 团队成员
如果您具有与 {{site.data.keyword.Bluemix_notm}} 帐户相链接的 SoftLayer 帐户，那么您可以添加 SoftLayer 团队成员。
 1. 转至**帐户** > **邀请团队成员**。 
 2. 在**添加 SoftLayer 团队成员**部分中单击**添加**，以在 SoftLayer 帐户中进行认证，并查看 SoftLayer 帐户的团队成员列表。 
 
向 {{site.data.keyword.Bluemix_notm}} 帐户添加团队成员并不会授予这些成员对 {{site.data.keyword.Bluemix_notm}} 基础架构的访问权。要授予用户对“基础架构”仪表板的访问权，请转至**基础架构** > **帐户** > **用户**，然后单击**添加用户**链接。您必须有权添加用户。
 
 有关从 SoftLayer 帐户添加团队成员的更多信息，请参阅[邀请 SoftLayer 团队成员加入 {{site.data.keyword.Bluemix_notm}}](/docs/admin/softlayerlink.html#invite_users)。
