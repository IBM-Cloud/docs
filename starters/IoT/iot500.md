...
6. Click Add New Card (for temperature).
  ...
  5. Card information.
       - Title: Temperature
  6.	Submit.
  7.	The temperature card will appear on the dashboard and graph the live temperature data.
7.	Click Add New Card (for humidity).
  ...
  6.	Card information.
       -	Title: Humidity
  7.	Submit.
  8.	The humidty card will appear on the dashboard and gauge will show the live humidity data.
